...
<body>
    ...
    if ($respuesta->num_rows > 0) {
        ...
        echo "      <th>";
        echo "          <b><a href='turnos.php?orden=1'>Fecha Del Turno</a></b>";
        echo "      </th>";
        ...
        echo "      <th>";
        echo "          <b><a href='turnos.php?orden=3'>Obra Social</a></b>";
        echo "      </th>";
    ...
    <center>
        <div class="otras-acciones">
            <a href='nuevoturno.php'><button class="btn-nuevo">Nuevo Turno</button></a>
            <a href="turnosHistorial.php"><button class="btn-historial">Historial</button></a>
        </div>
    </center>

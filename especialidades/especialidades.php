...
<body>
    ...
    if ($respuesta->num_rows > 0) {
        ...
        while ($row = mysqli_fetch_assoc($respuesta)) {
            ...
            echo "<a href='modificarespecialidad.php?ID=" . $row['id'] . "'><button class='btn-modificar'>Modificar</button></a>";
            echo " ";
            echo "<a href='eliminarespecialidad.php?ID=" . $row['id'] . "'><button class='btn-eliminar'>Eliminar</button></a>";
            echo "</td>";
        ...
        echo "<a href='nuevaespecialidad.php'><button class='btn-nuevo'>Nueva Especialidad</button></a> </center>";
    } else {
